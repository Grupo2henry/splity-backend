...
export const groupMembershipsSeed = [
  ...
  { user: usersSeed[0], group: groupsSeed[0], joined_at: new Date(), status: 'active', role: GroupRole.ADMIN },
  ...
  { user: usersSeed[0], group: groupsSeed[1], joined_at: new Date(), status: 'active', role: GroupRole.MEMBER },
  { user: usersSeed[1], group: groupsSeed[1], joined_at: new Date(), status: 'active', role: GroupRole.ADMIN },
  ...
  { user: usersSeed[0], group: groupsSeed[2], joined_at: new Date(), status: 'active', role: GroupRole.MEMBER },
  { user: usersSeed[1], group: groupsSeed[2], joined_at: new Date(), status: 'active', role: GroupRole.MEMBER },
  { user: usersSeed[2], group: groupsSeed[2], joined_at: new Date(), status: 'active', role: GroupRole.ADMIN },
  ...
  { user: usersSeed[1], group: groupsSeed[3], joined_at: new Date(), status: 'active', role: GroupRole.ADMIN },
  ...
  { user: usersSeed[1], group: groupsSeed[4], joined_at: new Date(), status: 'active', role: GroupRole.ADMIN },
  ...
  { user: usersSeed[1], group: groupsSeed[5], joined_at: new Date(), status: 'active', role: GroupRole.ADMIN },
  ...
  { user: usersSeed[2], group: groupsSeed[6], joined_at: new Date(), status: 'active', role: GroupRole.ADMIN },
  ...
  { user: usersSeed[3], group: groupsSeed[7], joined_at: new Date(), status: 'active', role: GroupRole.ADMIN },
  ...
  { user: usersSeed[4], group: groupsSeed[8], joined_at: new Date(), status: 'active', role: GroupRole.ADMIN },
  ...
  { user: usersSeed[4], group: groupsSeed[9], joined_at: new Date(), status: 'active', role: GroupRole.ADMIN },
  ...
  { user: usersSeed[5], group: groupsSeed[10], joined_at: new Date(), status: 'active', role: GroupRole.ADMIN },
  ...
  { user: usersSeed[5], group: groupsSeed[11], joined_at: new Date(), status: 'active', role: GroupRole.ADMIN },
  ...
  { user: usersSeed[6], group: groupsSeed[12], joined_at: new Date(), status: 'active', role: GroupRole.ADMIN },
  ...
  { user: usersSeed[6], group: groupsSeed[13], joined_at: new Date(), status: 'active', role: GroupRole.ADMIN },
  ...
  { user: usersSeed[7], group: groupsSeed[14], joined_at: new Date(), status: 'active', role: GroupRole.ADMIN },
  ...
  { user: usersSeed[7], group: groupsSeed[15], joined_at: new Date(), status: 'active', role: GroupRole.ADMIN },
